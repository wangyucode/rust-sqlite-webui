...
import { isQuerying, runQuery, currentTable, setSqlContent, selectedRowIndices, execSql, setShouldFocusSqlInput } from "../lib/store";
...
const Toolbar: Component = () => {
  ...
  return (
    <div class="flex gap-2">
      ...
      <button class="btn btn-sm btn-square btn-info" title="Insert" onClick={handleInsert}>
